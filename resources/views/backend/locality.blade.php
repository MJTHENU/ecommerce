			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('backend.partials.locality_table')
						</div>
					</div>
					<!--/Data grid/-->
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="locality_name">{{ __('Locality') }}<span class="red">*</span></label>
										<input type="text" name="locality_name" id="locality_name" class="form-control parsley-validated" data-required="true">
									</div>
								</div>
...
<script src="{{asset('public/backend/pages/locality.js')}}"></script>
@endpush