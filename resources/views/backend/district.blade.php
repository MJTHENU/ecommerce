			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('backend.partials.district_table')
						</div>
					</div>
					<!--/Data grid/-->
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="district_name">{{ __('District') }}<span class="red">*</span></label>
										<input type="text" name="district_name" id="district_name" class="form-control parsley-validated" data-required="true">
									</div>
								</div>
...
<script src="{{asset('public/backend/pages/district.js')}}"></script>
@endpush