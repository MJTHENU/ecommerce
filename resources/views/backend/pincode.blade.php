			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('backend.partials.pincode_table')
						</div>
					</div>
					<!--/Data grid/-->
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="pincode_name">{{ __('Pin Code') }}<span class="red">*</span></label>
										<input type="text" name="pincode_name" id="pincode_name" class="form-control parsley-validated" data-required="true">
									</div>
								</div>
...
<script src="{{asset('public/backend/pages/pincode.js')}}"></script>
@endpush