...
@section('title', __('Product Sub Categories'))
			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('backend.partials.product_subcategories_table')
						</div>
					</div>
					<!--/Data grid/-->
					<!--Data Entry Form-->
					<div id="form-panel" class="card-body dnone">
						<form novalidate="" data-validate="parsley" id="SubDataEntry_formId">
							<div class="row">
								<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="name">{{ __('Parent Category') }}<span class="red">*</span></label>
										<select name="parentcat" id="parentcat" class="chosen-select form-control">
											<option value="">None</option>
											@foreach($parentcatdatalist as $row)
...
<script src="{{asset('public/backend/pages/product-subcategories.js')}}"></script>
