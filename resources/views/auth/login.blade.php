...
<!-- main Section -->
<div class="container">
	<div class="row"> <div class="col-md-12"> <div class="loginsignup-area">
		<div class="loginsignup text-center"> <div class="logo"> <a href="{{ url('/login') }}">
			<img src="{{ $gtext['back_logo'] ? asset('public/media/'.$gtext['back_logo']) :
			asset('public/backend/images/backend-logo.png') }}" alt="logo">
			</a>
		</div>
		@if (session('message'))
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				@enderror" placeholder="{{ __('Password') }}" required autocomplete="current-password">
				</div>
