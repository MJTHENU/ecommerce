					...
					<div class="col-lg-6">
						<ul class="top-list">
							...
							@if (Route::has('frontend.register'))
								<li><a href="{{ route('frontend.seller-register') }}"><i class="bi bi-person-plus"></i>{{ __('Seller Register') }}</a></li>
							<li><a href="{{ route('frontend.register') }}"><i class="bi bi-person-plus"></i>{{ __('Customer Register') }}</a></li>
