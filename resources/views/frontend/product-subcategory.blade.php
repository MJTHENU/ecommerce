	...
	<section class="inner-section inner-section-bg">
		<div class="container">
			...
			@endif
					...
					<div id="tp_datalist">
						@include('frontend.partials.product-subcategory-grid')
					</div>
...
var subcat_id = "{{ isset($params) ? $params['subcat_id'] : 0 }}";
</script>
<script src="{{asset('public/frontend/pages/product-subcategory.js')}}"></script>
@endpush	