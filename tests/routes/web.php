...
Route::prefix('backend')->group(function(){
	...
	Route::post('/deleteLocality', [App\Http\Controllers\Backend\LocalityController::class, 'deleteLocality'])->name('backend.deleteCountry')->middleware(['auth','is_admin']);
	Route::post('/bulkActionCountry', [App\Http\Controllers\Backend\LocalityController::class, 'bulkActionCountry'])->name('backend.bulkActionCountry')->middleware(['auth','is_admin']);
